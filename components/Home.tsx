...
const HomeSection = ({ darkMode }: HomeSectionProps) => {
  return (
    ...
    >
      <div
        id="HomeContainer"
        className="flex flex-col justify-center items-center h-screen px-4 md:px-0"
      >
        <h1 className="text-4xl md:text-6xl text-yellow-500 m-10">
          Seonggyo Jung
        </h1>
        <div
        ...
        <div id="SNS" className="flex justify-around mt-4">
